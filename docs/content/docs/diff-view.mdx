...
<img
  ...
  alt="Diff view interface in Emdash"
  style={{
    width: '100%',
    maxWidth: '700px',
    margin: '20px auto',
...
**Create PR**: Use the PR button to push the branch if needed and open a PR or draft PR. This does not create a commit for you.
