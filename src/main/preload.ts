...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  lifecycleGetCustomScripts: (args: { projectPath: string }) =>
    ipcRenderer.invoke('lifecycle:getCustomScripts', args),
  ...
  getCheckRuns: (args: { taskPath: string; prNumber?: number }) =>
  ...
  listTaskBranches: (args: { taskPath: string; taskId?: string; remote?: string }) =>
    ipcRenderer.invoke('git:list-task-branches', args),
  switchTaskBranch: (args: {
    ...
    remote?: string;
    branchName?: string;
  }) => ipcRenderer.invoke('git:switch-task-branch', args),
...
export interface ElectronAPI {
  ...
  lifecycleGetCustomScripts: (args: { projectPath: string }) => Promise<{
    success: boolean;
