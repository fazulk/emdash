...
export const ForgejoIssuePreviewTooltip: React.FC<Props> = ({ issue, children, side = 'top' }) => {
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground">
                ...
                />
                <span className="tracking-wide">Forgejo Issue</span>
              ...
              {issue.html_url && (
                <a
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    if (window.electronAPI?.openExternal && issue.html_url) {
                      e.preventDefault();
...
export default ForgejoIssuePreviewTooltip;
