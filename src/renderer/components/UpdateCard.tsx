...
export function UpdateCard(): JSX.Element {
  ...
  function renderAction() {
    switch (updater.state.status) {
      ...
      case 'downloading':
        return (
          <Button size="sm" variant="outline" disabled aria-busy className="h-7 text-xs">
            <ButtonContentWithSpinner loading contentClassName="gap-1.5" spinnerClassName="h-3 w-3">
              <>
